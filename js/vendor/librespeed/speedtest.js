...
Speedtest.prototype = {
  ...
  start: function() {
    ...
    // ---- MODIFICADO POR BIFRÖST NETWORK ----
    // Ruta original: "speedtest_worker.js?r=" + Math.random()
    // Se cambia para que apunte a la ubicación real del worker dentro del proyecto (js/vendor/librespeed/).
    this.worker = new Worker("js/vendor/librespeed/speedtest_worker.js?r=" + Math.random());
